...
weather.open('GET', 'https://api.openweathermap.org/data/2.5/weather?id=5391811&units=imperial&APPID=93513a5ecb45a4d44be23c0ee39c9db3', true);
weather.send();
...
function showEvents(eventInfo) {
    ...
    for (i=0; i < eventDetails.length; i++) {
        if (eventDetails[i].name === "san-diego") {
